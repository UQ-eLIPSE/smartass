		        ...
		        <div class="panel-heading background-primary-color white clearfix">
		            <form action="repository-files.htm">
		                <div class="form-group">
		                    ...
		                    <input class="form-control" maxlength=128 id="search" name="search" size=55 title="Search by file name" value="<c:out value="${lastsearch}"/>"> <br>
	            ...
	            <div class="panel-body">
		            <table class="table" width="99%" cellspacing="0">
		                ...
		                <thead>
		    	            ...
		    	            <th>Description</th>
		    	            <th align="right">
				                <a class="pull-right" href="repository-file.htm?id=0"> New </a>
		    	            </th>
		                </thead>
