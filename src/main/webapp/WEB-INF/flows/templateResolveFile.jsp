        ...
        <div class="container">
            <table>
                    ...
                    <tr><td>
                        <table>
                            <tr>
                                ...
                                <td><input size="50" class="form-control" type="file" name="fileMultipart" id="fileMultipart" onchange="uploadFieldChange()"/></td>
                            </tr>
                            <tr>
                                <td><b>* Name:</b></td>
                                <td><form:input cssClass="form-control" size="50" path="file.name"/></td>
                            </tr>
                            <tr>
                                <td><b>Description:</b></td>
                                <td><form:input cssClass="form-control" size="50" path="file.description"/></td>
                            </tr>
                        </table>
                    </td></tr>
                </c:if>
                ...
                <c:if test="${(!empty item.file.name) && (!empty suggestions)}"> 
                    ...
                    <tr><td>
                      Search by file name: 
                      <form:input cssClass="form-control" path="search" maxlength="128" id="search" title="Search by file name"/>
