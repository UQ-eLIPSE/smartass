        ...
        <div class="container">
            <table>
                ...
                <c:if test="${(!empty item.module.name) && (!empty suggestions)}"> 
                    ...
                    <tr><td colspan="2">
                      Search by  name: 
                      <form:input cssClass="form-control" path="search" maxlength="128" id="search" title="Search by file name" size="40"/>
                ...
                <c:if test="${empty item.module.name}">
                    ...
                    <tr><td>
                        <table>
                            <tr>
                                <td><b>* Module name:</b></td>
                                <td><form:input cssClass="form-control" path="module.name" size="50" /></td>
                            </tr>
                            <tr>
                                <td><b>Module package:</b></td>
                                <td><form:input cssClass="form-control" path="module.modulePackage" size="50" /></td>
                            </tr>
                            <tr>
                                <td><b>Module parameters:</b></td>
                                <td><form:textarea cssClass="form-control" rows="6" cols="70" path="module.parameters" /></td>
                            </tr>
                            <tr>
                                <td><b>Description:</b></td>
                                <td><form:textarea cssClass="form-control" path="module.description" cols="56" rows="4"/></td>
                            </tr>
                        </table>
                    </td></tr>
                </c:if>
