...
/**
 * Describe class PythonEvalModule here.
 *
 *
 ...
 * @version 1.0
 */
public abstract class PythonEvalModule extends PythonModule {
     ...
     *
     */
    public PythonEvalModule(Engine engine) {
        super(engine);
    ...
    private final PythonResultBuffer printOutput() {
